...
public class Ejercicio01 {
    ...
    public static void main(String[] args) {
        ...
        int[] respuestas = {1, 10, 11, 12, 12, 13, 16, 17, 18, 8, 9, 10, 22, 33, 44, 55};// Fuera de rango 22, 33, 44, 55.
        String[] rangos = {"1-5", "6-10", "11-15", "16-20", "Fuera de rango", "Fuera de rango negativos"};
